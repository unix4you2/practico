	    ...
	    if (confirm(MULTILANG_PCODER_AdvertenciaCierre))
	        {
	            ...
	            for (i=0;i<ListaArchivos.length;i++)
	                ...
	                self.close();
	            //Oculta todo lo que pueda y publica mensaje avisando al usuario que cerro sus archivos
	            $("#MarcoContenedorSuperior").hide();
	            $("#MarcoContenedorCentral").html("<center><font color=gray><br><br><br>{P}Coder ha sido cerrado.  Puede cerrar su navegador.<br><br><br>{P}Coder was closed.  You can close this browser.</font></center>");
	            $("#MarcoContenedorInferior").hide();
                PCOJS_MostrarMensaje("Sesion", "<center>{P}Coder ha sido cerrado.  Puede cerrar su navegador.<br><br><br>{P}Coder was closed.  You can close this browser.</center>"," modal modal-wide ");
	            return true;
	        }
	    else
	        return false;
