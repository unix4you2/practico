				...
				if(ValorModoEditor!="")
					{
					    ...
					    if (BloqueoArchivo=="")
					        {
					            //Actualiza el registro de archivo como abierto
					            if (PCO_PCODER_StandAlone=="0")
					                {
            						    EstadoOperacion=PCO_ObtenerContenidoAjax(0,"index.php","PCO_Accion=PCOMOD_ActivarBloqueoArchivo&PCODER_archivo="+path_archivo);
					        ...
					        {
					            //Verifica si se desea cargar en solo lectura
