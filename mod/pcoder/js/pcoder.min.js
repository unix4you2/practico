...
function PCODER_CompararVersionArchivo()
    {
        alert(ListaArchivos[IndiceArchivoActual].RutaDocumento);
        ...
        //Asigna los valores de archivo a comparar
        // $("#archivo_diff_1").val(ListaArchivos[IndiceArchivoActual].RutaDocumento);
        // $("#archivo_diff_2").val(ListaArchivos[IndiceArchivoActual].RutaDocumento);
        // $("#formato_diff").val("oscuro");
        // $("#modo_visual_diff").val("ladoalado");
        //Llama al visor de diferencias
        //PCODER_EjecutarDiff();
