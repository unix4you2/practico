...
function Presentar_KeyBindings()
    {
        global $MULTILANG_Basicos,$MULTILANG_Otros,$MULTILANG_Desplazar,$MULTILANG_Seleccionar;
        echo '
            <div class="btn btn-success btn-block"><b>'.$MULTILANG_Basicos.'</b></div>
            ...
            <div class="btn btn-success btn-block"><b>'.$MULTILANG_Desplazar.'</b></div>
            <table class="table table-responsive table-bordered table-condensed table-hover btn-xs">
                <thead>
                    <tr>
                        <td><b>PC (Windows/Linux)</b></td>
            ...
            <div class="btn btn-success btn-block"><b>'.$MULTILANG_Seleccionar.'</b></div>
            <table class="table table-responsive table-bordered table-condensed table-hover btn-xs">
                <thead>
                    <tr>
                        <td><b>PC (Windows/Linux)</b></td>
            ...
            <div class="btn btn-success btn-block"><b>'.$MULTILANG_Otros.'</b></div>
            <table class="table table-responsive table-bordered table-condensed table-hover btn-xs">
                <thead>
                    <tr>
                        <td><b>PC (Windows/Linux)</b></td>
