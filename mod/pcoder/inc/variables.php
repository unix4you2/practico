<?php
	...
	*/
	...
	$PCODER_Modos[]=array(Nombre => "ADA",	Extensiones => "ada|adb");
	...
	$PCODER_Modos[]=array(Nombre => "CSharp",	Extensiones => "cs");
	...
	$PCODER_Modos[]=array(Nombre => "Forth",	Extensiones => "frt|fs|ldr");
	...
	$PCODER_Modos[]=array(Nombre => "LaTeX",	Extensiones => "tex|latex|ltx|bib");
	$PCODER_Modos[]=array(Nombre => "LESS",	Extensiones => "less");
	$PCODER_Modos[]=array(Nombre => "Liquid",	Extensiones => "liquid");
	$PCODER_Modos[]=array(Nombre => "Lisp",	Extensiones => "lisp");
	...
	$PCODER_Modos[]=array(Nombre => "Makefile",	Extensiones => "^Makefile|^GNUmakefile|^makefile|^OCamlMakefile|make");
	$PCODER_Modos[]=array(Nombre => "Markdown",	Extensiones => "md|markdown");
	...
	$PCODER_Modos[]=array(Nombre => "Pascal",	Extensiones => "pas|p");
	$PCODER_Modos[]=array(Nombre => "Perl",	Extensiones => "pl|pm");
	$PCODER_Modos[]=array(Nombre => "pgSQL",	Extensiones => "pgsql");
	$PCODER_Modos[]=array(Nombre => "PHP",	Extensiones => "php|phtml|inc");
	...
	$PCODER_Modos[]=array(Nombre => "SH",	Extensiones => "sh|bash|^.bashrc");
	...
	$PCODER_Modos[]=array(Nombre => "SQL",	Extensiones => "sql");
