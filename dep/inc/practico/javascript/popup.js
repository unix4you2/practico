	...
	Edited from original code from Geek Daily Blog - 2007 / Unknown author
...
function AbrirPopUp(formdiv_id)
{
    var bgdiv = document.getElementById("FondoPopUps");
    bgdiv.style.display="block";

    var formdiv = document.getElementById(formdiv_id);
    formdiv.style.display="block";

    var pt = window.center({width:document.getElementById(formdiv_id).offsetWidth,height:document.getElementById(formdiv_id).offsetHeight});
...
function OcultarPopUp(formdiv_id)
{
    var formdiv = document.getElementById(formdiv_id);
