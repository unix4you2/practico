...
(function() {
  ...
  this.VKI_kts = this.VKI_kt = "Espa\u00f1ol";  // Default keyboard layout
  this.VKI_langAdapt = true;  // Use lang attribute of input to select keyboard
  this.VKI_size = 2;  // Default keyboard size (1-5)
  this.VKI_sizeAdj = true;  // Allow user to adjust keyboard size
  this.VKI_clearPasswords = false;  // Clear password fields on focus
  this.VKI_imageURI = "img/teclado.png";  // If empty string, use imageless mode
  ...
  /* ***** i18n text strings ************************************* */
  this.VKI_i18n = {
    '00': "Ver teclado numerico",
    '01': "Abrir teclado virtual",
    '02': "Indicar distribucion",
    '03': "Teclas muertas",
    '04': "On",
    '05': "Off",
    '06': "Cerrar teclado",
