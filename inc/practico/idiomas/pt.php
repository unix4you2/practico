<?php
	...
	*/
	...
	$MULTILANG_FrmHlpFunciones='Todas as funções de JavaScript aqui definidos ser&aacute; inclu&iacute;do no formul&aacute;rio.<br>Se você precisa de alguns eventos adicionais ligados por botões ou qualquer objeto em forma<br> este campo permitem que você defini-los.<br><b>Quando você precisa usar parâmetros ou qualquer uso Citação sempre aspas duplas!</b>.<br>FrmAutoRun função deve ser existe (ainda vazio) porque ele ser&aacute; executado automaticamente em cada carregamento de formul&aacute;rio.';
	...
	$MULTILANG_InfGrafico2='Barras horizontais (v&aacute;rias s&eacute;ries)';
	$MULTILANG_InfGrafico3='Gr&aacute;fico de linha';
	$MULTILANG_InfGrafico4='Gr&aacute;fico de linha (s&eacute;rie m&uacute;ltipla)';
	$MULTILANG_InfGrafico5='As barras verticais';
	$MULTILANG_InfGrafico6='As barras verticais (s&eacute;rie m&uacute;ltipla)';
	$MULTILANG_InfGrafico7='Gr&aacute;fico de pizza (apenas uma s&eacute;rie)';
