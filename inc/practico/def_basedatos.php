<?php
	...
	*/
	...
	$ListaCamposSinID_menu='texto,padre,peso,url,destino,tipo_comando,comando,nivel_usuario,posible_arriba,posible_centro,posible_escritorio,seccion,imagen,posible_izquierda,tipo_menu,formulario,clase_contenedor';
