...
?>
				...
				<?php
					if ($PCOSESS_SesionAbierta && $PCO_Accion=="Ver_menu") {
						...
						$resultado=PCO_EjecutarSQL("SELECT ".$TablasCore."menu.id as id,$ListaCamposSinID_menu FROM ".$TablasCore."menu ".@$Complemento_tablas." WHERE posible_arriba=1 AND formulario=0 ".@$Complemento_condicion." ORDER BY peso");
