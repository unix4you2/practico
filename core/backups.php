...
Class DBBackup {
	...
	/**
	 *
	 * A prefix that identifies the tables for the backup.
	 * @var String
	 */
	private $prefix;
	...
	public function DBBackup($args){
		...
		if(!$args['prefix']) $this->error[] = 'Parameter prefix missing';
	...
	private function getTables(){
		try {
			...
			foreach($tbs as $table){
				//Verifica si la tabla tiene el prefijo solicitado
				if (strpos($table[0],$this->prefix)!==FALSE)
					{
