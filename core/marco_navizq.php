                    ...
                    <!--INICIO DE OPCIONES BARRA LATERAL-->
                        <ul class="nav" id="side-menu">
                            ...
                            <?php
                                ...
                                $resultado=PCO_EjecutarSQL("SELECT ".$TablasCore."menu.id as id,$ListaCamposSinID_menu FROM ".$TablasCore."menu ".@$Complemento_tablas." WHERE posible_izquierda=1 AND formulario=0 ".@$Complemento_condicion." ORDER BY peso");
