	...
	*/
	...
	/*
		...
		(start code)
			...
			practico='practico'; // Nombre de la base de datos a utilizar
	...
	*/
	...
	/*
		...
		*Llave de paso*
		...
		(start code)
			ABC=''; //Predeterminado en vacio con MD5=d41d8cd98f00b204e9800998ecf8427e
		(end)
	*/
	...
	$LlaveDePaso='ABC';  // Valor unico para firmar los usuarios del aplicativo.  No debe ser cambiado despues de puesto en marcha a menos que se haga un update manual el usuario que no coincida con la llave no podra ingresar.
	$ModoDepuracion=1;
