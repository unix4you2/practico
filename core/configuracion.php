<?php
	...
	*/
	...
	$ServidorBD='192.168.100.20';	// Direccion IP o nombre de host
	...
	*/
	...
	$LlaveDePaso='PO67MKM8G3';  // Valor unico para firmar los usuarios del aplicativo.  No debe ser cambiado despues de puesto en marcha a menos que se haga un update manual el usuario que no coincida con la llave no podra ingresar.
	$ModoDepuracion=0;
